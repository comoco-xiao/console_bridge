...
class CMakeBuildExt(build_ext):
    ...
    def copy_data(self, install_dir):
        # include
        include_path = os.path.join(self.build_lib, "console_bridge", "include")
        ...
        # lib
        lib_path = os.path.join(self.build_lib, "console_bridge", "lib")
    ...
    def _configure_and_build(self):
        ...
        install_dir = os.path.join(PROJECT_DIR, "console_bridge_install")
